...
/*  EXERCISE 1
    ...
    type orderNumbers = (a:number,b:number) => number
...
/*  sortDescending is a comparison function that tells the sort method how to sort 
    ...
    const sortDescending: orderNumbers=(a,b)=>{
        if (a > b) {
            return -1;
        } else if (b > a) {
            return 1;
    ...
    const sortAscending: orderNumbers=(a,b)=>{
        if (a > b) {
            return 1;
        } else if (b > a) {
            return -1;
        ...
        console.log("ordenar array", myArray1)
        console.log("prestamo", loanCalculator(1000,5))